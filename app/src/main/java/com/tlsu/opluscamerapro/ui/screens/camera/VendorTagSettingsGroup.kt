...
fun VendorTagSettingsGroup(
    ...
    Column(
        ...
        if (isNullDefaultValueEnableFunction( "enable25MP")) {
            HintCard {
                Text(
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_advanced)) {
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enable25MP"),
                enabled = !isNullDefaultValueEnableFunction( "enable25MP")
            )
...
//            )
            ...
            if (isV16()) {
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableGRWatermark"),
                    enabled = !isNullDefaultValueEnableFunction( "enableGRWatermark")
                )
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableLUMO"),
                    enabled = !isNullDefaultValueEnableFunction( "enableLUMO")
                )
            }
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableNewBeautyMenu"),
                enabled = !isNullDefaultValueEnableFunction( "enableNewBeautyMenu")
            )
...
//            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableQuickLaunch"),
                enabled = !isNullDefaultValueEnableFunction( "enableQuickLaunch")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableFrontCameraZoom"),
                enabled = !isNullDefaultValueEnableFunction( "enableFrontCameraZoom")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableGlobalEv"),
                enabled = !isNullDefaultValueEnableFunction( "enableGlobalEv")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableSwitchLensFocalLength"),
                enabled = !isNullDefaultValueEnableFunction( "enableSwitchLensFocalLength")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableMotionCapture"),
                enabled = !isNullDefaultValueEnableFunction( "enableMotionCapture")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableMultiFrameBurstShot"),
                enabled = !isNullDefaultValueEnableFunction( "enableMultiFrameBurstShot")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enable10bitPhoto"),
                enabled = !isNullDefaultValueEnableFunction( "enable10bitPhoto")
            )
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_master)) {
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableStyleEffect"),
                enabled = !isNullDefaultValueEnableFunction( "enableStyleEffect")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableMasterRawMax"),
                enabled = !isNullDefaultValueEnableFunction( "enableMasterRawMax")
            )
...
//                )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableSoftLightProMode"),
                enabled = !isNullDefaultValueEnableFunction( "enableSoftLightProMode")
            )
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_portrait)) {
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enablePortraitZoom"),
...
//            )
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_filter)) {
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableMasterFilter"),
                enabled = !isNullDefaultValueEnableFunction( "enableMasterFilter")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableTolStyleFilter"),
                enabled = !isNullDefaultValueEnableFunction( "enableTolStyleFilter")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableGrandTourFilter"),
                enabled = !isNullDefaultValueEnableFunction( "enableGrandTourFilter")
            )
...
//                visible = !isDefaultValueEnableFunction("enableDesertFilter"),
//                enabled = !isNullDefaultValueEnableFunction( "enableDesertFilter")
//            )
...
//                visible = !isDefaultValueEnableFunction("enableVignetteGrainFilter"),
//                enabled = !isNullDefaultValueEnableFunction( "enableVignetteGrainFilter")
//            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableJiangWenFilter"),
                enabled = !isNullDefaultValueEnableFunction( "enableJiangWenFilter")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableJzkMovieFilter"),
                enabled = !isNullDefaultValueEnableFunction( "enableJzkMovieFilter")
            )
...
//                visible = !isDefaultValueEnableFunction("enableMeisheFilter"),
//                enabled = !isNullDefaultValueEnableFunction( "enableMeisheFilter")
//            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableOs15NewFilter"),
                enabled = !isNullDefaultValueEnableFunction( "enableOs15NewFilter")
            )
...
//                    visible = !isDefaultValueEnableFunction("enableFlashFilter"),
...
//                )
                ...
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableSoftLightFilter"),
                    enabled = !isNullDefaultValueEnableFunction( "enableSoftLightFilter")
                )
            }
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableSoftLightPhotoMode"),
                enabled = !isNullDefaultValueEnableFunction( "enableSoftLightPhotoMode")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableSoftLightNightMode"),
                enabled = !isNullDefaultValueEnableFunction( "enableSoftLightNightMode")
            )
        }
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_video)) {
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enable720p60fps"),
                enabled = !isNullDefaultValueEnableFunction( "enable720p60fps")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableFront4KVideo"),
                enabled = !isNullDefaultValueEnableFunction( "enableFront4KVideo")
            )
            ...
            if (isV16()) {
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enable1080p120fpsVideo"),
                    enabled = !isNullDefaultValueEnableFunction( "enable1080p120fpsVideo")
                )
                ...
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enable4K120fpsVideo"),
                    enabled = !isNullDefaultValueEnableFunction( "enable4K120fpsVideo")
                )
            }
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableSlowVideo480fps"),
                enabled = !isNullDefaultValueEnableFunction( "enableSlowVideo480fps")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableVideoStopSoundImmediate"),
                enabled = !isNullDefaultValueEnableFunction( "enableVideoStopSoundImmediate")
            )
            ...
            if (isV16()) {
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableVideoAutoFps"),
                    enabled = !isNullDefaultValueEnableFunction( "enableVideoAutoFps")
                )
                ...
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableVideoLockLens"),
                    enabled = !isNullDefaultValueEnableFunction( "enableVideoLockLens")
                )
                ...
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableVideoLockWb"),
                    enabled = !isNullDefaultValueEnableFunction( "enableVideoLockWb")
                )
            }
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableVideoSoundFocus"),
                enabled = !isNullDefaultValueEnableFunction( "enableVideoSoundFocus")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableMicStatusCheck"),
                enabled = !isNullDefaultValueEnableFunction( "enableMicStatusCheck")
            )
        }
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_dolby)) {
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableDolbyVideo"),
                enabled = !isNullDefaultValueEnableFunction( "enableDolbyVideo")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableDolbyVideo60fps"),
                enabled = !isNullDefaultValueEnableFunction( "enableDolbyVideo60fps")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableDolbyVideo120fps"),
                enabled = !isNullDefaultValueEnableFunction( "enableDolbyVideo120fps")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableDolbyVideoSat"),
                enabled = !isNullDefaultValueEnableFunction( "enableDolbyVideoSat")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableFrontDolbyVideo"),
                enabled = !isNullDefaultValueEnableFunction( "enableFrontDolbyVideo")
            )
        }
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_macro)) {
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableNewMacroMode"),
                enabled = !isNullDefaultValueEnableFunction( "enableNewMacroMode")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableMacroTele"),
                enabled = !isNullDefaultValueEnableFunction( "enableMacroTele")
            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableMacroDepthFusion"),
                enabled = !isNullDefaultValueEnableFunction( "enableMacroDepthFusion")
            )
        }
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_other)) {
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableLivePhoto"),
                enabled = !isNullDefaultValueEnableFunction( "enableLivePhoto")
            )
            ...
            if (isV16()) {
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableMasterModeLivePhoto"),
                    enabled = !isNullDefaultValueEnableFunction( "enableMasterModeLivePhoto")
                )
            }
//            SettingsSwitchItem(
...
//            )
            ...
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableLivePhotoFovOptimize"),
                enabled = !isNullDefaultValueEnableFunction( "enableLivePhotoFovOptimize")
            )
...
//                visible = !isDefaultValueEnableFunction("enableHeifBlurEdit")
//            )
            if (isV16()) {
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enablePreviewHdr"),
                    enabled = !isNullDefaultValueEnableFunction( "enablePreviewHdr")
                )
            }
            SettingsSwitchItem(
        ...
        SettingsCard(title = stringResource(R.string.camera_settings_category_hasselblad)) {
            SettingsSwitchItem(
                ...
                visible = !isDefaultValueEnableFunction("enableHasselbladWatermark"),
                enabled = !isNullDefaultValueEnableFunction( "enableHasselbladWatermark")
            )
            ...
            if (isV16()) {
                SettingsSwitchItem(
                    ...
                    visible = !isDefaultValueEnableFunction("enableXPAN"),
                    enabled = !isNullDefaultValueEnableFunction( "enableXPAN")
                )
...
//                    visible = !isDefaultValueEnableFunction("enableHasselbladHighPixel"),
//                    enabled = !isNullDefaultValueEnableFunction( "enableHasselbladHighPixel")
//                )
            }
        }
